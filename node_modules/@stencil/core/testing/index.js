/*!
 Stencil Testing v4.10.0 | MIT Licensed | https://stenciljs.com
 */
...
lockfile = createCommonjsModule((function(e) {
 e.exports = function(e) {
  ...
  var f, m, g, y, v, _, b, w, E, S, T, x, C, $, A, D, O, k, N, P, L, R, F, j, I, M, H;
  Object.defineProperty(t, "__esModule", {
   value: !0
  ...
  }), t.hardlinksWork = (j = (0, (f || n()).default)((function*(e) {
  ...
  }), t.makeTempDir = (I = (0, (f || n()).default)((function*(e) {
  ...
  l = s.GLOBSTAR = o.GLOBSTAR = {}, c = r(175), u = {
   ...
   var n, s, o, i, a, c, f, g, y, v, _, b, w, E, S, T, x, C, $, A, D, O, k, N, P, L, R, F, j, I, M, H;
   ...
   for (O = c.length - 1; O > -1; O--) {
    ...
    L += R = s.slice(k.reEnd), F = N.split("(").length - 1, j = R, w = 0; w < F; w++) j = j.replace(/\)[+*?]?/, "");
    I = "", "" === (R = j) && t !== m && (I = "$"), s = N + P + R + I + L;
   }
   ...
   if (!e._n) {
    ...
    v((function() {
     for (var n = e._v, s = 1 == e._s, o = 0, i = function(t) {
      ...
      try {
       a ? (s || (2 == e._h && j(e), e._h = 1), !0 === a ? r = n : (u && u.enter(), r = a(n), 
...
const validateConfig = (e = {}, t) => {
 ...
 w.extras.scopedSlotTextContentFix = !!w.extras.scopedSlotTextContentFix), w.extras.experimentalScopedSlotChanges = !!w.extras.experimentalScopedSlotChanges, 
 setBooleanConfig(w, "sourceMap", null, void 0 === w.sourceMap || w.sourceMap), setBooleanConfig(w, "watch", "watch", !1), 
 setBooleanConfig(w, "buildDocs", "docs", !w.devMode), setBooleanConfig(w, "buildDist", "esm", !w.devMode || !!w.buildEs5), 
 setBooleanConfig(w, "profile", "profile", w.devMode), setBooleanConfig(w, "writeLog", "log", !1), 
 setBooleanConfig(w, "buildAppCore", null, !0), setBooleanConfig(w, "autoprefixCss", null, w.buildEs5), 
 setBooleanConfig(w, "validateTypes", null, !w._isTesting), setBooleanConfig(w, "allowInlineScripts", null, !0), 
 isString(w.taskQueue) || (w.taskQueue = "async"), isBoolean(w.hashFileNames) || (w.hashFileNames = !w.devMode), 
 isNumber(w.hashedFileNameLength) || (w.hashedFileNameLength = 8), w.hashedFileNameLength < 4 && (buildError(f).messageText = "validatedConfig.hashedFileNameLength must be at least 4 characters"), 
